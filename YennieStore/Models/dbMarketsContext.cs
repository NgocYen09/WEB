...
namespace YennieStore.Models
{
    public partial class dbMarketsContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-143OO84\\SQLEXPRESS;Initial Catalog=dbYennieStore;User ID=sa;Password=2802;TrustServerCertificate=true");
            }
        }
        ...
        public DbSet<YennieStore.ModelViews.RegisterViewModel> RegisterViewModel { get; set; }

        public DbSet<YennieStore.ModelViews.LoginViewModel> LoginViewModel { get; set; }
    }
}
